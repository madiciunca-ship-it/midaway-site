...
Cu o mână și un picior rupt, cu energia adunată în rucsac ca un talisman, după ce traversasem alte insule din Indonezia, am ajuns – într-un final – în Raja Ampat.  
...
Atât.`,
        qna: [
          { q: "1. Cine ești în câteva fraze?", a: "Numele meu este Yassir. Sunt din Maroc și mă simt profund conectat cu natura – albastrul mării, verdele pădurilor, frumusețea liniștită a locurilor neatinse. De aceea trăiesc cu rucsacul în spate: să mă mut dintr-un loc frumos în altul mi se pare cel mai natural lucru pentru mine." },
          { q: "2. Ce te-a împins să pleci la drum?", a: "Sincer, totul a început din cauza vremii din Maroc – dar și pentru că sunt o persoană activă. Nu-mi puteam imagina să stau într-un singur loc când știam că există altele, mai potrivite pentru mine, care mă așteptau." },
          ...
          { q: "4. Ce loc ți-a schimbat cel mai mult felul de a privi lumea?", a: "Indonezia, în special prima mea călătorie în Bali. Să trăiesc o cultură, o natură și un stil de viață complet diferite mi-a deschis mintea. M-a făcut să reflectez la multe lucruri pe care le consideram „normale”." },
          { q: "5. Cum te-a schimbat călătoria ca om?", a: "Călătoriile mi-au schimbat dorințele. Înainte cheltuiam bani pe lucruri materiale; acum prefer aventurile și descoperirea locurilor noi. Am descoperit și că pot trăi singur foarte mult timp, fără probleme – fără să simt că îmi lipsește ceva." },
          { q: "6. Un moment greu de pe drum și cum l-ai depășit.", a: "Sincer, încă nu am trăit un moment cu adevărat dificil. Poate sunt mai puternic din fire, sau poate pur și simplu nu văd lucrurile ca fiind atât de dificile." },
          ...
          { q: "9. Bonus: Cum ne-am cunoscut?", a: "Am întâlnit-o pe Mida în Raja Ampat. Am stat în același loc, am mâncat împreună și ne-am cunoscut treptat. Am devenit prieteni în mod natural. Câteva luni mai târziu, Mida a venit în Maroc, după ce am invitat-o. Iar până astăzi am rămas în contact." },
        ],
        story: [],
      },
      en: {
...
Along the way, I went through trials that would have stopped many people: pain, exhaustion, injuries, setbacks – moments when everything felt like too much.
...
Sam, the owner of a little homestay in Arborek, insisted that I go to his place. He called me, insisted again, and I told him:
        
— If I reach the port and you’re still there, I’ll come with you. If not… don’t wait for me.
        
But the Universe wanted me there.  
And it made sure I arrived there.
...
Why do I say that?  
Because later, I realised our meeting was more than a simple coincidence.  
Thanks to him, months later, I ended up in Morocco.  
Without knowing it, Yassir became one of those people who quietly shift your path – subtly, deeply, exactly the way the Universe likes to send signs.
        
I visited him in Tangier, his hometown.  
I met his family, his brothers, his little nephew.  
We shared local sweets, explored the city, walked along the beach and laughed together like two people who were never meant to meet… yet were somehow meant to meet all along.
        
Without him, none of what followed would have happened.  
And today, I thank him for all of it.
        
Some connections can’t be explained in words.  
They can only be lived.  
And felt.`,
        qna: [
          { q: "1. Who are you in a few sentences?", a: "My name is Yassir. I’m from Morocco, and I’m someone who feels deeply connected to nature – the blue of the sea, the green of the forest, the quiet beauty of untouched places. That’s why I live out of a backpack: moving from one beautiful place to another feels like the most natural thing in the world to me." },
          { q: "2. What made you start traveling?", a: "Honestly, it started with the weather in Morocco – and also with the fact that I’m naturally an active person. I couldn’t imagine staying in one place when I knew there were better places out there waiting for me – places that matched who I am." },
          { q: "3. When did you know it was worth it?", a: "It hits me every time I arrive somewhere new and finally see it with my own eyes. That moment of being stunned by the real beauty of a place – that’s when I know I’ve made the right choice." },
          { q: "4. A place that changed the way you see the world?", a: "Indonesia, especially my first trip to Bali. Experiencing a totally different culture, nature, and lifestyle has really opened my mind. It made me reflect on many things I grew up thinking were “normal.”" },
          { q: "5. How did traveling change you as a person?", a: "Traveling changed my desires. I used to spend money on material things; now I prefer spending it on adventures and discovering new places. I also discovered that I can live alone for a very long time without any problems – without feeling like I’m missing anything." },
          { q: "6. A hard moment on the road and how you overcame it.", a: "Honestly, I haven’t experienced a truly difficult moment yet. Maybe I’m built tough, or maybe I just don’t easily see things as difficult." },
          { q: "7. A tip for someone who wants to leave but still hesitates.", a: "If you’re poor, work, save money and travel to a new continent – it will change your perspective, your desires, maybe even your whole future. You only have one life; the more paths you see, the better you’ll understand which one is right for you. And if you already have money, I don’t really see a reason not to travel – unless you simply don’t enjoy it, after giving it a real try." },
          { q: "8. Where can we find you (IG / FB / YouTube / TikTok / site / blog)?", a: "I’m on YouTube: @freedomtells – that’s where I’ve shared some of my adventures from Indonesia and Raja Ampat." },
          { q: "9. Bonus: How did we meet?", a: "I met Mida in Raja Ampat. We stayed in the same place, ate together and slowly got to know each other. We became friends naturally. A few months later, Mida visited me in Morocco after I invited her. To this day, we’re still in touch." },
        ],
        story: [],
      },
      video: null,
