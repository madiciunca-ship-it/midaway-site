...
`Acest text face parte din seria „No Connection – Jurnale de drum din China”.`,
...

  {
    ...
    minutes: 12,
    content: [
      `Decizia de a pleca din Zhangjiajie n-a fost calculată; a venit pe moment.`,
      ...
      `Încă nu eram decisă: rămân în Guilin sau merg direct spre Yangshuo?`,
      `Guilin era nodul; Yangshuo era tentația.`,
      `Ca de obicei în China, telefonul a devenit, din nou, un obiect decorativ.`,
      ...
      `*Guilin: un ochi după baie, unul după Yangshuo*`,
      ...
      `La un moment dat, pe geam, am văzut ceva ce nu părea real. Munții iconici din Yangshuo.`,
      ...
      `Trăise câțiva ani în Singapore și lucrase mult timp ca șofer de autobuz intern în Yangshuo. Și nu asta m-a impresionat cel mai mult – ci faptul că, într-o țară în care engleza e aproape o raritate, întâlneam exact omul care putea să mă înțeleagă.`,
      ...
      `Și am intrat.`,
      `*Hotelul „închiriat de Univers” și barca spre West Street*`,
      ...
      `*Xingping: în interiorul bancnotei*`,
      ...
      `Râul Li curgea lent, ca o respirație veche. Munții aceia imposibili, ca niște coloane de cer, se ridicau de-o parte și de alta, reflectați în apă. Era exact peisajul de pe bancnota chinezească – aceea pe care o vezi de sute de ori fără să-i dai importanță.`,
      ...
      `După plimbarea pe râu, am intrat în orașul vechi din Xingping.`,
      ...
      `*Dinspre Vietnam, înapoi spre Hong Kong*`,
      `Teoretic, planul era altul.`,
      `În plan era să merg spre Nanning și de acolo să iau trenul către Vietnam. Așa fusese desenat traseul. Așa „avea sens”.`,
      ...
      `De acolo, am luat trenul spre Shenzhen. Nu direct. Niciodată direct.`,
      ...
      `Din Shenzhen, am luat primul tren care m-a trecut granița.`,
      ...
      `Acest text face parte din seria „No Connection – Jurnale de drum din China”.`,
      `În următorul articol, mi-a mai rămas un singur oraș de trăit: Hong Kong.`,
      `Stai aproape. Drumul continuă.`,
    ]
  },

    {
      ...
      minutes: 13,
      content: [
        `După o zi care a mers împotriva oricărei logici, am înțeles ceva simplu: China nu voia să mai stau.`,
        ...
        `*Shenzhen: locul în care n-am mai vrut să rămân*`,
        `Am ieșit din gară doar ca să trag aer în piept. Pe trotuar, între oameni care treceau grăbiți pe lângă mine, am știut: nu mai rămân aici. N-am stat nici cinci minute. M-am întors în gară, am ocolit-o aproape mecanic, am găsit un ghișeu, am cerut un bilet către Hong Kong și m-am urcat în primul tren.`,
        ...
        `Știam deja că Hong Kong-ul nu e genul de loc în care „găsești ceva decent la un preț ok”. Nu scump. Aproape absurd.`,
        ...
        `Am găsit unul. Nu ieftin, dar suficient de aproape încât să nu mai conteze. Trei zile, atât mai aveam. Destinația? Bali. 275 de euro.`,
        `Și, pentru prima dată după mult timp, nu am mai analizat. Am închis laptopul și am știut că plec.`,
        `*Trei zile în Hong Kong: mersul ca formă de supraviețuire*`,
        ...
        `Am urcat cu un autobuz până la Mount Kellett. Voiam să văd orașul de sus. Am plătit 11 euro pe o focaccia cu rozmarin. Am râs. Dar am făcut poze. Multe. Și, acolo sus, era cald. Am stat în cămașă, cu orașul sub mine, încercând să înțeleg dacă îmi place sau nu.`,
        ...
        `Am trecut și pe insule. Am ajuns la marele Buddha de aur. (Poza de pe cover e din complexul Po Lin Monastery, de lângă Marele Buddha – un loc care contrasta perfect cu agitația orașului.) Impresionant, liniștit, aproape opusul orașului. Acolo am mâncat cea mai bună mâncare de când plecasem. Vegetariană. Simplă. Perfectă. Și am descoperit ceva nou: mochi. Dulciuri mici, moi, aproape tăcute, dar imposibil de uitat.`,
        ...
        `Wan Chai Promenade. Victoria Peak. Central–Mid-Levels Escalators. The Peak, văzut din toate unghiurile posibile. Apoi Lantau. N-am ajuns la Disneyland. Nu aveam timp. Și, sincer, nici energia. Dar am văzut Ngong Ping Cable Car, SkyTrail 360, Ngong Ping Village.`,
        `Și, seară de seară, m-am întors la Harbourfront Promenade, ca la un ritual. Un oraș în care nu te oprești… dar în care revii, fără să-ți dai seama, în aceleași locuri.`,
...

  {
    ...
    content: [
      ...
      `Cartea asta e o confesiune, un jurnal lucid: e scrisă din interior, cu vocea la vedere.`,
      ...
      `Eram în Johor, în Malaezia, când s-a întâmplat conversația. El locuia acolo. Eu eram în trecere, ca de obicei – între două lumi, între două versiuni ale mele, între ceea ce știam deja și ceea ce urma să descopăr la întoarcerea mea în România.`,
      ...
      `Au urmat continente, drumuri, limbi, camere străine. Și un fir care, în ciuda mea, nu se rupea. Și, la capătul lor, China – fără bilet de întoarcere.`,
      ...
      `Au venit proceduri legale, editură, detalii administrative care nu se văd în carte, dar îți pot opri complet ritmul. Printre toate astea, a venit și o alergie care m-a țintuit în Bali mai mult decât aș fi vrut să recunosc. Și adevărul pe care îl învăț de fiecare dată: lucrurile nu vin când le ceri, ci când sunt pregătite.`,
      ...
      `„Focuri care nu ating” – o colecție de trăiri reale, filtrate prin ceea ce am simțit în fiecare dintre ele, nu doar prin ceea ce s-a întâmplat.`,
      `*Blocajul*`,
      ...
      `Îți mulțumesc.`,
      `Citește cartea. Recitește-o. Apoi întoarce-te doar la acele capitole care au mișcat ceva în tine. Păstrează aproape povestea care a rămas. Și las-o să-ți spună restul.`,
