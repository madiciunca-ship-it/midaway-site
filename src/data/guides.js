...
const guides = [
    // ────────────────────────────────────────────────────────────
    // 1) Nguyen — Ghid în Saigon (Vietnam)
    // ────────────────────────────────────────────────────────────
    {
      id: "ghid-saigon",
      emoji: "🛵",
      ...
      ro: {
        intro: `Ghizii adevărați nu arată doar locuri — ei deschid uși. Nguyen trăiește Saigonul cu toată inima: piețe care se trezesc înainte de răsărit, străzi care vibrează de mirosul cafelei cu lapte condensat și un trafic care curge ca un râu viu. Cu el am învățat că orașele pot fi prietenoase când ai un om bun lângă tine.`,
        qna: [
      ...
      en: {
        intro: `Real guides don’t just show places — they open doors. Nguyen *lives* Saigon with all his heart: dawn markets, the sweet smell of condensed-milk coffee, and scooter rivers flowing through the city. With him I learned that cities can feel gentle when you have a kind human by your side.`,
        qna: [
