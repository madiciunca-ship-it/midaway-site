...
{ type: "paragraph", parts: [{ text: "În următoarele articole, iau orașele la rând, așa cum le-am trăit: " }, { text: "Zhangjiajie", href: "https://www.google.com/maps/place/Zhangjiajie/", kind: "external" }, { text: ", " }, { text: "Yangshuo", href: "https://www.google.com/maps/place/Yangshuo/", kind: "external" }, { text: " și " }, { text: "Hong Kong", href: "https://www.google.com/maps/place/Hong+Kong/", kind: "external" }, { text: "." }] },
...

  {
    ...
    minutes: 10,
    content: [
      `Știți deja că sunt de multă vreme prin Sri Lanka. Mai exact, am aproape trei luni de cutreierat pe insula asta mică, dar atât de densă, încât ai impresia că nu se termină niciodată.`,
      ...
      `Sunt de vreo opt zile într-un orășel de pe coastă, în Hikkaduwa. De când am ajuns aici, mi-am tot propus să merg la Galle. Am mai fost acolo o dată, într-o zi, dar eram cu bagajul după mine și nu am apucat mare lucru. M-am dus doar să beau o cafea la Barista și acolo am dat peste o localnică.`,
      ...
      `Asta a fost atunci, acum vreo nouă zile. De atunci, mi-am tot spus că trebuie să ajung din nou în Galle. Să văd zona Fortului. Să mă plimb pe străduțe. Știam că sunt minunate. În fiecare zi îmi ziceam: mâine. Azi parcă nu am chef.`,
