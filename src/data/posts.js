...
{ type: "paragraph", parts: [{ text: "În următoarele articole, iau orașele la rând, așa cum le-am trăit: " }, { text: "Zhangjiajie", href: "https://www.google.com/maps/place/Zhangjiajie/", kind: "external" }, { text: ", " }, { text: "Yangshuo", href: "https://www.google.com/maps/place/Yangshuo/", kind: "external" }, { text: " și " }, { text: "Hong Kong", href: "https://www.google.com/maps/place/Hong+Kong/", kind: "external" }, { text: "." }] },
...

  {
    ...
    minutes: 12,
    content: [
      `Midaway.ro nu a apărut dintr-un plan perfect. Nici dintr-o strategie rece, desenată cap-coadă, cu toate etapele bifate dinainte. Nici din siguranța că știu exact ce fac, cât va dura, cât mă va costa – și mă refer aici la timp, nu la bani – sau în ce se va transforma.`,
      `Nu.`,
      ...
      `Pentru că ajungi în puncte în care nu mai știi. Pur și simplu nu mai știi. Descoperi că lucruri care par nevinovate pot fi, de fapt, vulnerabilități serioase. Că un fișier poate fi public fără să înțelegi de la început că este public. Că datele oamenilor care cumpără de la tine pot ajunge expuse dacă nu înțelegi bine mecanismele din spate.`,
      `Că o singură schimbare de limbă, aparent banală, poate atinge zeci de fișiere și o logică întreagă pe care nu ai voie să o rupi. Că „să arate bine” pe desktop și pe mobil nu înseamnă doar estetică, ci grijă, coerență, timp și foarte multă răbdare.`,
      `Și, în același timp, descoperi și altceva. Descoperi ce face mintea ta atunci când intră pe un teritoriu pe care nu îl stăpânește.`,
      `Acolo apar acele întrebări pe care foarte mulți oameni le cunosc, chiar dacă nu le spun cu voce tare:`,
      ...
      `Dacă poți contribui, fie și cu un singur atom – metaforic vorbind, desigur – la îmbunătățirea a ceea ce am construit până acum, îmi poți scrie. Eu răspund. Răspund oricui vine cu bună-credință, cu claritate, cu o idee, cu o observație sau cu dorința sinceră de a ajuta.`,
      `Iar dacă nu ești tu omul care poate vedea ce îmi scapă încă, dar simți că acest text ar putea ajunge la cineva care știe, poate, mai bine, poți să-l duci mai departe. Și asta este tot o formă de ajutor. Uneori sprijinul nu vine direct, ci circulă prin oameni, aproape tăcut, până găsește locul potrivit în care să se așeze. Poate că și un astfel de gest se contorizează undeva sus – metaforic vorbind, desigur – ca o mică, dar reală contribuție la ceva care încearcă să crească frumos.`, 
      ...
      `Și poate că asta este una dintre cele mai frumoase surprize ale acestui parcurs: faptul că, pornind de una singură, ajungi să creezi ceva care poate deschide dialog, întâlnire și posibilitate.`,
