  ...
  const ui =
    lang === "en"
      ? {
          ...
          subtitleRo: "Pentru articolele în limba română, poți schimba limba din selectorul RO / EN.",
subtitleEn: "For Romanian-language articles, you can switch the language using the RO / EN.",
      ...
      : {
          ...
          subtitleRo: "Pentru articolele în limba engleză, poți schimba limba din selectorul RO / EN.",
subtitleEn: "For English-language articles, you can switch the language using the RO / EN.",
