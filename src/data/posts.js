...
{ type: "paragraph", parts: [{ text: "În următoarele articole, iau orașele la rând, așa cum le-am trăit: " }, { text: "Zhangjiajie", href: "https://www.google.com/maps/place/Zhangjiajie/", kind: "external" }, { text: ", " }, { text: "Yangshuo", href: "https://www.google.com/maps/place/Yangshuo/", kind: "external" }, { text: " și " }, { text: "Hong Kong", href: "https://www.google.com/maps/place/Hong+Kong/", kind: "external" }, { text: "." }] },
...

  {
    ...
    content: [
      ...
      `Azi pot spune că site-ul nu este în forma lui finală. Poate încă nu a ajuns să fie tot ceea ce poate deveni. Cred asta din ce în ce mai mult. Poate că este încă în mișcare, exact cum sunt toate lucrurile vii. Exact cum atomii din univers nu stau locului, nici ideile mele nu rămân fixe, nici construcțiile reale nu se închid definitiv. Totul se mișcă. Totul se transformă. Totul curge. Iar informația, la rândul ei, circulă, se rafinează, se mută dintr-o minte în alta și schimbă forma lucrurilor atunci când este întâmpinată cu deschidere.`,
