...

  {
...

    {
      ...
      content: [
        ...
        `*Prima oprire: WiFi, nu entuziasm*`,
        `Am intrat într-o cafenea, dar nu pentru cafea. Pentru un singur lucru: WiFi.`,
        `Acolo, în cafeneaua aceea rece, unde o cafea costa aproape șapte euro, am primit parola de WiFi și, pentru prima dată după mult timp, am simțit că am din nou acces la o lume, așa cum o știam eu. Primul instinct: cazare.`,
        ...
        `Noaptea aceea… nu a fost noapte. Am stat pe marginea patului, cu laptopul în brațe. În sfârșit, aveam WiFi. Și atunci s-a întâmplat. Fișierul meu din China — tot. A dispărut. Pur și simplu. Ca și cum cineva ar fi apăsat „delete”. Ca și cum o mână invizibilă ar fi decis că nu mai am nevoie de el.`,
        `Ore întregi am încercat să-l recuperez. Tot ce mi-a oferit internetul, am încercat. Recuperări, backup-uri, soluții improvizate. Nimic. La un moment dat, nu mai știam dacă încerc să salvez un fișier… sau să refuz un verdict. Doar pe la trei dimineața, am cedat. Nu am plâns, dar am înțeles. A fost unul dintre acele momente în care nu mai ai nevoie de explicații, doar de acceptare. Așa am știut: China nu va fi o carte. Cel mult… o serie de articole. Atât.`,
        ...
        `Dimineața a venit târziu. Era aproape 11 când am reușit, în sfârșit, să mă ridic din pat.`,
        ...
        `Am trecut și pe insule. Am ajuns la marele Buddha de aur. Impresionant, liniștit, aproape opusul orașului. Acolo am mâncat cea mai bună mâncare de când plecasem. Vegetariană. Simplă. Perfectă. Și am descoperit ceva nou: mochi. Dulciuri mici, moi, aproape tăcute, dar imposibil de uitat.`,
