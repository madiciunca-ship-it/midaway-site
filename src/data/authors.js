...
const authors = [
  {
    ...
    ro: {
      ...
      bio: [
        ...
        "În ultimii trei ani, am călătorit prin trei continente: Asia, Europa, Africa – provocându-mă să mă eliberez de limitele și temerile care credeam că mă definesc. Scrierea a fost întotdeauna modul meu de a înțelege lumea, iar prin călătoriile mele, am descoperit că singurele limite reale cu care ne confruntăm sunt cele pe care le creăm în mintea noastră.",
