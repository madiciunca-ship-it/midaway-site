...
export default function Donate() {
  console.log("Componenta Donate s-a încărcat");

  return (
    <div style={{ padding: "24px 0 48px", maxWidth: 900, margin: "0 auto" }}>
      <header
      ...
      >
        ...
        <p style={{ color: "var(--secondary)", marginTop: 8 }}>
          Abonamente, donații unice și parteneriate. Împreună ducem poveștile
          mai departe.
        </p>
      </header>
      ...
      >
        <h2 className="font-cormorant" style={{ marginTop: 0, fontSize: 26 }}>
          Donație prin transfer bancar
        </h2>
        <p>Poți susține Midaway și prin transfer direct:</p>
        <div style={{ display: "grid", gap: 8 }}>
          <div>
            <strong>Asociația MIDAWAY</strong>
          </div>
          <div>
            IBAN RON: <code>RO00 BANK 0000 0000 0000 0000</code>
          </div>
          <div>
            IBAN EUR: <code>RO00 BANK 0000 0000 0000 0000</code> (SWIFT:{" "}
            <code>BANKROBU</code>)
          </div>
          <div>
            Detalii plată: <em>Donație Midaway – Nume Prenume</em>
          </div>
        </div>
        <div
          style={{
      ...
      <section style={{ marginTop: 24 }}>
        <h2 className="font-cormorant" style={{ fontSize: 26 }}>
          Parteneriate & Sponsorizări
        </h2>
        <p>
