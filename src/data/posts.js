...
{ type: "paragraph", parts: [{ text: "În următoarele articole, iau orașele la rând, așa cum le-am trăit: " }, { text: "Zhangjiajie", href: "https://www.google.com/maps/place/Zhangjiajie/", kind: "external" }, { text: ", " }, { text: "Yangshuo", href: "https://www.google.com/maps/place/Yangshuo/", kind: "external" }, { text: " și " }, { text: "Hong Kong", href: "https://www.google.com/maps/place/Hong+Kong/", kind: "external" }, { text: "." }] },
  ...
  {
    slug: "calugarul-si-respectul",
    title: "Călugărul și respectul",
    excerpt: "Într-un bus aglomerat din Sri Lanka, între Hikkaduwa și Galle, am văzut cum respectul poate schimba locurile oamenilor fără ca nimeni să rostească aproape nimic. A urcat un călugăr tânăr, în robă portocalie, iar autobuzul întreg s-a reașezat în jurul lui. Atunci am înțeles că, în unele locuri, respectul nu se declară. Se practică.",
    date: "2026-05-02",
    author: "Mida Malena",
    tags: [
      "Midaway",
    ...
    cover: "/assets/blog/calugarul-si-respectul.jpeg",
    lang: "ro",
    minutes: 10,
    content: [
      { type: "paragraph", parts: [{ text: "Știți deja că sunt de multă vreme prin " }, { text: "Sri Lanka", href: "/sri-lanka", kind: "internal" }, { text: ". Mai exact, am aproape trei luni de cutreierat pe insula asta mică, dar atât de densă, încât ai impresia că nu se termină niciodată." }] },
      `Nu am văzut chiar tot. Am văzut ce m-a atras, ce m-a chemat, ce mi s-a părut că merită. Și vor urma, probabil, câteva articole despre Sri Lanka, pentru că am adunat în mine multe locuri, multe drumuri, multe chipuri și multe întâmplări.`,
      `Dar astăzi vreau să vă povestesc ceva proaspăt. O întâmplare dintr-un bus. Una dintre acele întâmplări mici, de câteva minute, care îți rămân în cap mult după ce ai coborât.`,
      `Îmi plac busurile din Sri Lanka. În primul rând, pentru că sunt ieftine. Nu ieftine. Super ieftine. Un drum de o oră m-a costat mai puțin de doi lei. Da, cam atât de ieftine.`,
      { type: "paragraph", parts: [{ text: "Sunt de vreo opt zile într-un orășel de pe coastă, în " }, { text: "Hikkaduwa", href: "/sri-lanka/hikkaduwa", kind: "internal" }, { text: ". De când am ajuns aici, mi-am tot propus să merg la " }, { text: "Galle", href: "/sri-lanka/galle", kind: "internal" }, { text: ". Am mai fost acolo o dată, într-o zi, dar eram cu bagajul după mine și nu am apucat mare lucru. M-am dus doar să beau o cafea la Barista și acolo am dat peste o localnică." }] },
      `O fată cu ochi triști.`,
      `M-a văzut că îmi caut un loc strategic în cafenea și s-a dat puțin la o parte, să-mi facă loc lângă ea. Am stat cu ea vreo două ore la povești. Avea nevoie să vorbească. Eu aveam timp să ascult.`,
      { type: "paragraph", parts: [{ text: "Asta a fost atunci, acum vreo nouă zile. De atunci, mi-am tot spus că trebuie să ajung din nou în Galle. Să văd zona " }, { text: "Fortului", href: "https://maps.app.goo.gl/c9DqNacTnnEFhG459?g_st=iw", kind: "external" }, { text: ". Să mă plimb pe străduțe. Știam că sunt minunate. În fiecare zi îmi ziceam: mâine. Azi parcă nu am chef." }] },
      `Și azi-dimineață, cheful a apărut. Așa, din senin.`,
      `Lucrez la o carte nouă și, sincer, nu prea voiam să-mi ies din mood. Dar pe la amiază am decis să plec. Stația e chiar lângă mine. Trec strada și hop, sunt în bus.`,
      `Am urcat în primul care a venit. M-am așezat frumos în spatele șoferului, locul meu preferat. Pe dreapta erau bănci de câte trei persoane, pe stânga de câte două. Busul era aproape gol când am pornit. Trei oameni, poate patru. O liniște rară pentru Sri Lanka.`,
      `Știam că facem cam o oră, așa că nu m-am grăbit nicăieri. Priveam pe geam, mai făceam poze, filmulețe. Vântul îmi zbura prin păr. Drumul curgea. Marea apărea și dispărea printre clădiri, tuk-tuk-uri, tarabe, palmieri, reclame colorate și oameni care păreau că știu exact unde se duc.`,
      `Lângă mine s-au tot perindat femei. Una cobora, alta urca. Apoi alta. Și încă una. În Sri Lanka, busul nu e doar mijloc de transport. E o lume în mișcare. Oamenii sunt adunați de pe traseu, ca și cum drumul însuși îi culege. În câteva stații, autobuzul aproape gol devenise plin.`,
      `La un moment dat, într-o stație, a urcat un călugăr. Era tânăr. Foarte tânăr. Nu cred că avea nici 25 de ani. Purta roba aceea pământiu-portocalie, specifică lor, prinsă peste bustul gol, cu un umăr dezgolit. Exact imaginea aceea pe care o vezi prin temple, pe străzi, în fotografii, dar care capătă altă greutate când e lângă tine, într-un bus aglomerat.`,
      `Și atunci s-a întâmplat ceva.`,
      `Cele două femei de lângă mine s-au ridicat brusc.`,
      `Nu încet, nu ezitant, nu cu un gest de politețe făcut pe jumătate. S-au ridicat imediat. Ca și cum corpul lor știa ce are de făcut înainte ca mintea mea să apuce să înțeleagă.`,
      `M-am uitat la el. M-am uitat la ele. M-am uitat din nou la el.`,
      `Una dintre femei mi-a văzut mirarea și mi-a spus un singur cuvânt:`,
      `— Monk.`,
      `Călugăr.`,
      `Atât.`,
      `Ca și cum explicația era suficientă. Ca și cum, din acel cuvânt, eu ar fi trebuit să înțeleg tot. De ce s-au ridicat. De ce nu s-a comentat. De ce nu a existat nicio urmă de iritare, nicio privire obosită, niciun „dar de ce eu?”.`,
      `Călugăr.`,
      `Femeile, trecute de prima tinerețe, s-au ridicat ca să-i facă loc.`,
      `Eu mă uitam la scena asta cu mirarea turistului care crede că a înțeles câte ceva despre o țară și descoperă, într-o fracțiune de secundă, că nu a înțeles mare lucru.`,
      `Dar surpriza nu s-a terminat acolo.`,
      `Călugărul nu s-a așezat lângă mine. Nici pe locul eliberat de cele două femei.`,
      `Fără să spună niciun cuvânt, a făcut un semn către femeile din spatele meu. Acolo erau trei femei, una lângă alta, pe bancheta din spate.`,
      `Și ele s-au ridicat. Pur și simplu.`,
      `A urmat o mică vânzoleală. Femeile din față s-au mutat, unele s-au schimbat între ele, cineva a trecut pe culoar, cineva a rămas în picioare. Eu stăteam acolo și mă uitam ca la un film mut, încercând să prind logica unei lumi care se desfășura la câțiva centimetri de mine.`,
      `În cele din urmă, călugărul s-a așezat pe bancheta din spate. Singur.`,
      `Nicio femeie nu s-a așezat lângă el. Au rămas în picioare. Doar două dintre ele, nu sunt sigură dacă aceleași care stătuseră inițial lângă mine, s-au așezat până la urmă pe banca mea. Dar bancheta călugărului a rămas goală în jurul lui. Ca un spațiu rezervat nu doar corpului lui, ci statutului lui.`,
      `Sincer, atât respect pentru un călugăr, mai ales într-un autobuz public, nu am văzut nicăieri în cei doi ani de când călătoresc.`,
      `Și nu era un respect festiv. Nu era nimic pregătit. Nu era un templu, nu era o ceremonie, nu era o procesiune. Era un bus obișnuit, ieftin, aglomerat, cu oameni obosiți, cu sacoșe, cu telefoane, cu drumuri de făcut și cu vieți de dus mai departe.`,
      `Tocmai de aceea m-a lovit atât de tare. Pentru că respectul acela nu avea scenă. Nu avea public. Nu avea nevoie de aplauze. Era pur și simplu acolo, în reflexul unor oameni.`,
      `Călugărul a rămas tăcut.`,
      `După o vreme, un bărbat s-a așezat sfios pe marginea banchetei, spre culoar, la o distanță respectuoasă de el. Mai târziu, băiatul care tăia bilete în bus i-a făcut semn unui alt bărbat să se așeze acolo. Și așa, lângă călugăr au ajuns să stea doar bărbați.`,
      `Atunci am început să înțeleg, sau măcar să bănuiesc, că poate femeile nu aveau voie să stea lângă el. Sau poate nu se cuvenea. Sau poate era vorba despre un amestec de regulă, credință, respect și obișnuință. Nu știu sigur. Și nici nu vreau să mă prefac că știu mai mult decât am văzut.`,
      `Dar ceea ce am văzut a fost suficient.`,
      `Am văzut câteva femei ridicându-se fără revoltă, fără ezitare și fără să ceară explicații. Am văzut un tânăr călugăr care nu a cerut loc cu voce tare, dar pentru care spațiul s-a creat instantaneu. Am văzut un autobuz întreg reașezându-se în jurul unei robe portocalii.`,
      `Curiozitatea mea era mare, vă dați seama.`,
      `Cum mă tot jucam cu telefonul, la un moment dat l-am surprins într-o poză. Era chiar în spatele meu. I-am văzut privirea în ecran.`,
      `Nu pot spune că era caldă. Dar nici rece nu era. Nu știu cum să o explic. Avea ceva retras, ceva greu de citit. Poate liniște. Poate distanță. Poate doar oboseala unui drum lung, într-un bus plin.`,
      `Cert este că momentul acela m-a urmărit până în Galle. Când am coborât, el era încă acolo. Tăcut, în roba lui pământiu-portocalie, cu locul din jurul lui schimbat de prezența lui.`,
      `Eu am coborât în orașul pe care voiam să-l văd de zile întregi. Fortul, străduțele, marea, clădirile coloniale, toate mă așteptau. Dar înainte de toate astea, Sri Lanka îmi arătase încă o dată ceva ce nu scrie în ghiduri.`,
      `Că respectul, atunci când e cu adevărat înrădăcinat într-o cultură, nu are nevoie de explicații.`,
      `Se vede în corp.`,
      `În felul în care cineva se ridică.`,
      `În felul în care altcineva face loc.`,
      `În felul în care un autobuz întreg se reașază, în tăcere, în jurul unui om.`,
      `Iar eu, străina de pe bancheta din față, am rămas cu imaginea asta mult după ce am coborât în Galle: un călugăr tânăr, o robă portocalie și câteva femei care au înțeles, fără să li se spună nimic, că respectul uneori nu se declară.`,
      `Se practică.`,
      `Azi am văzut respectul ridicându-se în picioare. La propriu.`,
`Și, tot din respect, poza de copertă a acestui articol nu va fi cu el. Va fi cu marea din Galle.`,
`Sau nu... m-am răzgândit. Va fi cu acest câine întâlnit acolo, întins pe piatră, liniștit și demn, ca o mică lecție că respectul nu se cere întotdeauna.`,
